module.exports.run = async (bot, message, args) => {
	...
	if(!steamURL) return help.helpMessage(message, "Steam", "Converts any steam proflie URL into steam hex ID", "[Steam Profile URL]", "https://steamcommunity.com/id/xTornadoZz/", "https://steamcommunity.com/id/chucklesmcdonald/");
